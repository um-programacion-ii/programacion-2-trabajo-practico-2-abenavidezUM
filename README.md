...
Este proyecto implementa un sistema para gestionar una biblioteca digital con funcionalidades como categorización de recursos, préstamos básicos de recursos, búsquedas y notificaciones.
...
- `sistema.biblioteca.modelos`: Clases que representan los objetos del dominio (Usuario, Libro, Prestamo, etc.)
...
- Sistema de reservas con manejo de concurrencia
